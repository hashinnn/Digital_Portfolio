...
export const about = {
  ...
  paragraphs: [
    'I build **full-stack**, but most of what I make, nobody sees. I am most at home in the back end — designing the schema, writing the queries, wiring up the API, then finding out what breaks. That has meant **MySQL and Postgres**, **REST services on Node and Flask**, live updates over **Socket.IO**, and a **serverless pipeline on AWS Lambda, DynamoDB and EventBridge**. On the data side I work in **Tableau, Power BI and DAX**, and I care more about whether a chart changes someone’s decision than whether it looks good.',
    'The other half of what I do happens in a room full of people. Through **NYP Cloud Computing** and **NYP Ladies in Tech** I help **run hackathons and hands-on workshops** — scoping the problems, lining up the tooling, and making sure a beginner can actually finish something by the end. Through **NYAA** I have run community sessions too: teaching **seniors to spot scam calls and phishing attempts**, and getting students to engage with **sustainability** without it being another lecture.',
    'Those two halves are more alike than they look. Explaining a scam call to someone who has never heard of phishing is the same job as writing an error message that tells a user what to do next. I am looking for **software and data engineering roles** where I can **own a feature from the schema to the screen**, and stay long enough to find out whether it held up.',
  ],
  extracurriculars: [
    {
      ...
      items: [
        ...
        'Organise hackathons and hands-on workshops that get beginners started in tech',
      ],
    },
    {
      label: 'Volunteering',
